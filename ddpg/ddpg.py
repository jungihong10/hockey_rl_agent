# stable-baselines3: https://github.com/DLR-RM/stable-baselines3/tree/master/stable_baselines3/ddpg
...
class DDPG(TD3):
    ...
    def __init__(
        ...
        replay_buffer_class: Optional[type[ReplayBuffer]] = PrioritizedReplayBuffer,  # Use your new buffer
        ...
        # ✅ Ensure replay_buffer_kwargs is initialized
        if replay_buffer_kwargs is None:
            replay_buffer_kwargs = {}

        # ✅ Ensure `env` is properly initialized before accessing observation/action spaces
        if isinstance(env, str):
            raise ValueError("`env` must be a Gym environment, not a string.")
